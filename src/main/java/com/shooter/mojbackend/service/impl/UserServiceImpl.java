...
import com.shooter.mojbackend.enums.UserRoleEnum;
...
import com.shooter.mojbackend.mapper.UserMapper;
...
import static com.shooter.mojbackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "shooter";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) { // 防止快速点击注册，发起两次注册
            // 账户不能重复
